package think.rpgitems.utils.nms.v1_8_R2;
...
public class EntityTools_v1_8_R2 implements IEntityTools {
    @Override
    public void setEntityTag(Entity e, String tag) {
        net.minecraft.server.v1_8_R2.Entity nmsEntity = ((CraftEntity) e).getHandle();
        ...
        if (nmsEntity instanceof EntityPlayer) {
            ...
            if (!nmsClonedNBT.equals(nmsOrigNBT)) {
                ...
                try {
                    Field field = net.minecraft.server.v1_8_R2.Entity.class.getDeclaredField("uniqueID");
