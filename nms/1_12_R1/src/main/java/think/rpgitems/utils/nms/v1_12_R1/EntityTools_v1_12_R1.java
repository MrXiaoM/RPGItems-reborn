package think.rpgitems.utils.nms.v1_12_R1;
...
public class EntityTools_v1_12_R1 implements IEntityTools {
    @Override
    public void setEntityTag(Entity e, String tag) {
        ...
        if (nmsEntity instanceof EntityPlayer) {
            ...
            NBTTagCompound nmsOrigNBT = nmsEntity.save(new NBTTagCompound()); // entity to nbt
