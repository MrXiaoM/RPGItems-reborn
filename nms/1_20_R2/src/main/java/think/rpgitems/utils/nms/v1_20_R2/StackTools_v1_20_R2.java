package think.rpgitems.utils.nms.v1_20_R2;
...
public class StackTools_v1_20_R2 implements IStackTools {
    ...
    public ItemStack itemFromBinary(byte[] nbt, int offset, int len) throws IOException {
        ...
        NBTTagCompound reconstructedCompoundTag = NBTTagCompound.b.c(dataInputStream, unlimitedNbtAccounter);
