...
public class NBTTagTools_v1_20_R4 implements INBTTagTools {
    ...
    public Optional<String> getString(ItemStack item, String key) {
        ...
        CustomData custom = item1.get().a(DataComponents.b);
        NBTTagCompound tag = custom == null ? null : custom.c();
    ...
    public Optional<String> setString(ItemStack item, String key, String value) throws NoSuchFieldException, IllegalAccessException {
        ...
        CustomData custom = itemStack.a(DataComponents.b);
        NBTTagCompound tag = custom != null ? custom.c() : new NBTTagCompound();
        tag.a(key, value);
        itemStack.a(DataComponentPatch.a().a(DataComponents.b, CustomData.a(tag)).a());
